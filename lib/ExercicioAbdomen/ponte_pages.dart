...
class Ponte extends StatefulWidget {
  const Ponte({super.key});

  @override
  _Ponte createState() => _Ponte();
}

class _Ponte extends State<Ponte> {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: primeiro, deite-se de bruços em um tapete de academia. Em seguida, apoie os antebraços nele (opcionalmente pode-se mantê-los esticados como mostra a animação acima).Então, levante o corpo do chão, se apoiando nos dedos dos pés e nos cotovelos.Lembre-se de manter o abdômen contraído.',
                              style:
