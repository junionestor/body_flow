...
class AbdominalTradicional extends StatefulWidget {
  const AbdominalTradicional({super.key});

  @override
  _AbdominalTradicional createState() => _AbdominalTradicional();
}

class _AbdominalTradicional extends State<AbdominalTradicional> {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: primeiro, deite-se sobre uma superfície plana, preferencialmente sobre um colchonete. Em seguida, flexione as pernas formando um ângulo de aproximadamente 60 graus.Então, apoie as mãos na nuca ou na altura das orelhas. Depois, contraia o abdômen e eleve os ombros e a cabeça em direção aos joelhos. Não se esqueça de inspirar e espirar durante o movimento.',
                              style:
