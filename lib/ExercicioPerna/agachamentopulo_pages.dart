...
class AgachamentoPulo extends StatefulWidget {
  const AgachamentoPulo({super.key});

  @override
  _AgachamentoPulo createState() => _AgachamentoPulo();
}

class _AgachamentoPulo extends State<AgachamentoPulo> {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: a posição inicial é em pé, com a postura reta e os pés separados em uma distância correspondente à largura dos ombros. Então, faça o agachamento, mantendo os joelhos levemente atrás da linha dos dedos dos pés, até que as coxas estejam paralelas ao chão. Logo em seguida, impulsionando as pernas e colocando a pressão no calcanhar, pule o mais alto que puder, utilizando a maior força possível. Use todo o pé para saltar, especialmente os calcanhares, e não somente os dedos dos pés. Ao tocar novamente no solo, dobre levemente os joelhos para aliviar o impacto.',
                              style:
