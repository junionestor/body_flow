...
class AbdominalBicicleta extends StatefulWidget {
  ...
  @override
  _AbdominalBicicleta createState() => _AbdominalBicicleta();
}

class _AbdominalBicicleta extends State<AbdominalBicicleta> {
        ...
        child: ListView(children: [
          Column(
            ...
            children: [
              ...
              const Image(
                  image: AssetImage('assets/images/abdominalbicicleta.webp'),
                  width: 400,
                  height: 400),
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: primeiro, eleve as pernas formando um ângulo de 90 graus. Em seguida, apoie as mãos na nuca ou na altura das orelhas. Então, simule o movimento de pedaladas com as pernas e direcione os cotovelos para os joelhos. Gire o tronco para realizar o exercício.',
                              style:
