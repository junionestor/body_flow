...
class Stepup extends StatefulWidget {
  ...
  @override
  _Stepup createState() => _Stepup();
}

class _Stepup extends State<Stepup> {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: posicione-se em pé em frente a uma caixa ou banco. Então, coloque o pé direito em cima da caixa ou banco e deixe o pé esquerdo no chão. Em seguida, em um único movimento, suba no objeto e levante a perna esquerda para que a coxa fique paralela ao solo, e o pé direito esticado. Faça um número determinado de repetições até trocar as pernas de posição',
                              style:
