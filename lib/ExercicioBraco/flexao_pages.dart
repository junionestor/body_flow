...
class FlexaoBraco extends StatefulWidget {
  const FlexaoBraco({super.key});

  @override
  _FlexaoBraco createState() => _FlexaoBraco();
}

class _FlexaoBraco extends State<FlexaoBraco> {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text(
                              'Como fazer: deitar de barriga para baixo, levantar o corpo esticando os braços alinhados ao corpo, em uma distância um pouco maior que a largura dos ombros, os pés no chão,  abdômen contraído e costas alinhadas. Levantar e abaixar o corpo apenas dobrando e esticando os braços em um ângulo de 90º com o cotovelo. Não deitar no chão entre as flexões.Caso o exercício seja muito difícil é possível realizá-lo com os joelhos no chão e, aos poucos, ir retirando os joelhos do chão.',
                              style:
